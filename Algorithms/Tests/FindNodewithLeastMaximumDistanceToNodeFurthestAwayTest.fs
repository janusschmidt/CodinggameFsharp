module Algorithms.FindNodewithLeastMaximumDistanceToNodeFurthestAwayTest
...
let ``Example 1`` () =
    ...
    let sut = FindNodewithLeastMaximumDistanceToNodeFurthestAway.calculate edges
    
    Assert.Equal("3",sut.nodeId)
    Assert.Equal(2,sut.distance)
